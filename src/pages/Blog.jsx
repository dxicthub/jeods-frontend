...
// Import all images from assets/home_cards_imgs
...
const Blog = () => {
  ...
  // University images array with 20+ different images from asset folder - No write-ups
  ...
  // Duplicate images for seamless scrolling (3 times for smooth infinite loop)
  const scrollingImages = [...universityImages, ...universityImages, ...universityImages];

  // Simulated live updates from external websites with 2026 dates and actual URLs
  useEffect(() => {
  ...
  // Carousel animation - non-stop scrolling
  useEffect(() => {
    ...
    const animate = () => {
      if (!isPaused && carousel) {
        ...
        // Reset when reaching the end of the duplicated content
  ...
  const handleRegisterClick = (serviceName) => {
  ...
  // Service categories with detailed information and one big image each
  const services = [
    {
      id: 1,
  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        {/* Live Updates Ticker */}
        <div className="mb-12 bg-gradient-to-r from-primary-600/20 to-secondary-600/20 rounded-2xl p-6 border border-white/10">
          <div className="flex items-center gap-3 mb-4">
            <span className="text-2xl">📢</span>
            <h3 className="text-xl font-bold text-white">Live Updates 2026</h3>
              ...
              {liveUpdates.map((update) => (
                <div key={update.id} className="flex items-center gap-3 p-3 bg-white/5 rounded-lg hover:bg-white/10 transition-colors">
                  ...
                  <button 
                    ...
                    className="text-primary-500 hover:text-primary-400 text-sm cursor-pointer"
                  >
                    Visit Website →
                  </button>
                </div>
              ...
              <div className="p-6 md:p-8">
                ...
                <div className="grid md:grid-cols-2 gap-8">
                  <div>
                    <h3 className="text-xl font-semibold text-white mb-4 flex items-center gap-2">
                      <span>✨</span> What We Offer - {service.year}
                    </h3>
                  ...
                  <div>
                    <h3 className="text-xl font-semibold text-white mb-4 flex items-center gap-2">
                      <span>📢</span> {service.year} Updates
                    </h3>
                ...
                <div className="mt-8 flex flex-wrap gap-4">
                  ...
                  {service.showBrochure && (
                    <button 
                      onClick={() => handleRegisterClick(service.title)}
                      className="px-6 py-2 rounded-lg border border-primary-500 text-primary-500 hover:bg-primary-500 hover:text-white transition-all duration-300"
                    >
                      Download {service.year} Brochure
                    </button>
                  )}
                  <a href="https://wa.me/2347061066372" target="_blank" rel="noopener noreferrer" className="px-6 py-2 rounded-lg bg-green-600 hover:bg-green-700 text-white transition-all duration-300 flex items-center gap-2">
        ...
        {/* Featured Partner Universities Carousel Section - Only Images, Square, No Write-ups */}
        <motion.div
          initial="hidden"
          whileInView="visible"
          viewport={{ once: true }}
        ...
        >
          ...
          {/* Carousel Container - Non-stop scrolling with square images only */}
          <div 
            ref={carouselRef}
          ...
          >
            <div className="flex gap-6" style={{ width: 'max-content' }}>
              {scrollingImages.map((uni, idx) => (
                ...
                >
                  {/* Square image frame - no write-ups */}
        ...
        >
          ...
          <h3 className="text-2xl font-bold text-white mb-2">Your Success Story Starts Here in 2026</h3>
